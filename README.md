...
The CPS security state machine transitions between states such as:
...
The scheduler evaluates real-time constraints and reports:•	Cycle elapsed time
	•	Deadline violations
	•	Worst-Case Execution Time (WCET)
	•	CPU utilization
	•	Scheduling risk detection

Example output:--- SCHEDULING ANALYSIS ---
WCET: 0.0552s
Utilization: 1.11
...
This allows real-time inspection of system resilience and security behavior.
